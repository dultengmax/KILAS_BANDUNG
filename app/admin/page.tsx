...
export default function AdminDashboard() {
  ...
  const categories = [
    { id: 1, name: "Politik", count: 34, color: "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300" },
    {
      id: 2,
      name: "Olahraga",
      count: 28,
    ...
    { id: 5, name: "Gaya Hidup", count: 33, color: "bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300" },
  ]
      ...
      <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 dark:from-blue-500 dark:to-blue-700 rounded-lg p-2 w-10 h-10 flex items-center justify-center">
        ...
        {activeTab === "categories" && (
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-lg transition flex items-center gap-2">
                <Plus className="w-5 h-5" />
                Tambah Kategori
              </button>
            </div>
